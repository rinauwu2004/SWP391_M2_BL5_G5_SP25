<%--
    Document   : createUser
    Created on : Apr 30, 2025, 2:00:00 AM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Create New User - QuizMaster Admin</title>
                    ...
                    <form action="<%=request.getContextPath()%>/admin/users" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <p class="form-help-text">Password must be at least 8 characters long and include at least one uppercase letter, one lowercase letter, and one number.</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="roleId" name="roleId" class="form-control" required>
                                    <c:forEach var="role" items="${roles}">
                                        <option value="${role.id}" ${formData.roleId eq role.id ? 'selected' : ''}>${role.name}</option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="statusId" name="statusId" class="form-control" required>
                                    <c:forEach var="status" items="${statuses}">
                                        <option value="${status.id}" ${formData.statusId eq status.id ? 'selected' : ''}>${status.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="countryId" name="countryId" class="form-control" required>
                                    <c:forEach var="country" items="${countries}">
                                        <option value="${country.id}" ${formData.countryId eq country.id ? 'selected' : ''}>${country.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
