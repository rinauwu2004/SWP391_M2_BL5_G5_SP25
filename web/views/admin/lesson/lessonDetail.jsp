...
<main class="main-content">
        ...
        <div class="detail-container">
            <div class="detail-header">Lesson Details</div>

            <div class="detail-row">
                <div class="label">Lesson ID:</div>
                <div class="value">LSN${lesson.id}</div>

                <div class="label">Created At:</div>
                <div class="value">${lesson.createdAt}</div>
            </div>

            <div class="detail-row">
                <div class="label">Lesson Name:</div>
                <div class="value"><b>${lesson.name}</b></div>

                <div class="label">Modified At:</div>
                <div class="value">${lesson.modifiedAt}</div>
            </div>

            <div class="detail-row">
                <div class="label">Subject:</div>
                <div class="value">${lesson.subjectId.name}</div>
