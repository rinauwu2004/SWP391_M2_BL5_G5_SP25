<%-- 
    Document : Signup 
    Created on : 18 Apr 2025, 07:59:41 
    Author : Rinaaaa 
--%>
    ...
    <body>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <span class="input-status" id="firstNameStatus"></span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <span class="input-status" id="lastNameStatus"></span>
                        </div>
        ...
        <script>
            ...
            function validateFirstName() {
                ...
                const regexFistName = /^[A-ZÀ-Ý][a-zà-ÿ']+$/;
                return regexFistName.test(firstName);
            }
            function validateLastName() {
                const lastName = document.getElementById("lastName").value;
                const regexLastName = /^([A-ZÀ-Ý][a-zà-ÿ']*([A-ZÀ-Ý][a-zà-ÿ']*)?\s?)+$/;
            ...
            window.addEventListener("DOMContentLoaded", () => {
                ...
                document.getElementById("firstName").addEventListener("blur", () => {
                    ...
                    validateField("firstName", validateFirstName, "First name must start with an uppercase letter and contain only one word.");
                });

                document.getElementById("lastName").addEventListener("blur", () => {
                    touchedFields["lastName"] = true;
                    validateField("lastName", validateLastName, "Last name must start with an uppercase letter and have at least 2 letters.");
                });
