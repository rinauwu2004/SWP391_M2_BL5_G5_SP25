...
public class DeleteSubjectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean isDeleted = subjectDao.deleteSubjectById(id);

            if (isDeleted) {
                session.setAttribute("message", "Subject delete successfully.");
                response.sendRedirect("list-subject");
            } else {
                session.setAttribute("error", "Delete failed course or ID not found.");
                response.sendRedirect("list-subject");
            }
            ...
            session.setAttribute("error", "An error occurred while deleting the course: " + e.getMessage());
            response.sendRedirect("list-subject");
        }
    }
