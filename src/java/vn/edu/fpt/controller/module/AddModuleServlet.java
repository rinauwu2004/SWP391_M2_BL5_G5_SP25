...
public class AddModuleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("views/admin/module/addModule.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (name == null || name.isEmpty() || description == null || description.isEmpty()) {
            session.setAttribute("error", "Module name and description are required.");
            response.sendRedirect("addModule?lessonId=" + lessonId);
            return;
        }
        
        try {
            ModuleDAO moduleDAO = new ModuleDAO();
            boolean success = moduleDAO.createModule(Integer.parseInt(lessonId), name, description, url);
            ...
            if (success) {
                ...
                session.setAttribute("error", "Failed to update module.");
                response.sendRedirect("addModule?lessonId=" + lessonId);
            }
            ...
            e.printStackTrace();
            request.setAttribute("errorMessage", "Error occurred while updating the module.");
