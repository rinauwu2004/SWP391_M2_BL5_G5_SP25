<%-- 
    Document   : editQuiz
    Created on : Apr 29, 2025, 1:00:00 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <!-- Edit Quiz Form -->
        <section class="edit-quiz-section">
            <div class="container">
                <h1 class="edit-quiz-title">Edit Quiz</h1>
                ...
                <div class="form-card">
                    <form action="<%=request.getContextPath()%>/quiz/edit" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="timeLimit" name="timeLimit" class="form-control" value="${quiz.timeLimit}" min="1" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="status" class="form-label">Status<span class="required">*</span></label>
                                <select id="status" name="status" class="form-control" required>
                                    <option value="active" ${quiz.status eq 'active' ? 'selected' : ''}>Active</option>
                                    <option value="inactive" ${quiz.status eq 'inactive' ? 'selected' : ''}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p>${quiz.code}</p>
                            <small>The quiz code is generated automatically and cannot be changed.</small>
                        </div>
                        
                        <div class="form-actions">
                            <a href="<%=request.getContextPath()%>/quiz/view?id=${quiz.id}" class="btn btn-outline">Cancel</a>
